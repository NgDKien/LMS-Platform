...
export default function ModernSidebar() {
    ...
    return (
        <div className="flex h-screen bg-purple-200">
            {/* Collapsed Sidebar */}
            {!isOpen && (
                <div className="w-16 bg-zinc-800 rounded-2xl m-4 flex flex-col items-center py-4 gap-1 relative">
                    <button
            ...
            >
                <div className="bg-zinc-800 rounded-2xl m-4 h-[calc(100vh-2rem)] flex flex-col">
