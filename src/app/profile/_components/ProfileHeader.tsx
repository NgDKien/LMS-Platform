...
function ProfileHeader({ userStats, userData, user }: ProfileHeaderProps) {
    ...
    const STATS = [
        {
            label: "Đoạn mã đã chạy",
            value: userStats?.totalExecutions ?? 0,
            icon: Activity,
            color: "from-blue-500 to-cyan-500",
            gradient: "group-hover:via-blue-400",
            description: "Tổng số mã thực thi",
            metric: {
                label: "Trong vòng 24h qua:",
        ...
        },
        {
            ...
            description: "Lưu lại cho lần sau",
            metric: {
